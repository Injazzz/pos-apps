    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center gap-2 text-white">
          ...
          <h1 className="text-2xl font-bold">POS Delivery Order</h1>
        ...
        {import.meta.env.DEV && (
          <div className="text-slate-500 text-xs text-center space-y-1">
            <p>Dev accounts: manager@pos.com / kasir@pos.com / kurir@pos.com</p>
            <p>Password: <code className="bg-slate-700 px-1 rounded">password</code></p>
          </div>
        )}
      </div>
    </div>
